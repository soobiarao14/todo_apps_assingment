...
def validate_acceptance_criteria():
    ...
    if success and msg == "No tasks found":
    ...
    if success and "ID 1" in msg:
        print("[PASS] Task added successfully with ID 1")
    else:
        print("[FAIL] Add task")
        all_passed = False
    ...
    if success and "complete" in msg.lower():
    ...
    # Verify update
    if manager.tasks[0].title == "Buy more groceries" and "butter" in manager.tasks[0].description:
    ...
    if len(manager.tasks) == 100:
        print("[PASS] Handles 100+ tasks")
    else:
        print("[FAIL] Many tasks handling")
        all_passed = False
