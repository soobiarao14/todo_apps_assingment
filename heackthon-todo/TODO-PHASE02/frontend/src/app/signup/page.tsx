        ...
        <form className="mt-8 space-y-6 animate-fade-in-up" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-4 py-3 border-2 border-purple-300 placeholder-gray-400 text-gray-900 rounded-xl focus:outline-none focus:ring-4 focus:ring-purple-300 focus:border-purple-500 transition-all duration-300 sm:text-sm"
          ...
          {(validationError || error) && (
            <div className="rounded-2xl bg-gradient-to-r from-red-100 to-pink-100 border-2 border-red-400 p-4 animate-shake">
              <p className="text-sm text-red-800 font-bold">❌ {validationError || error}</p>
            </div>
          )}
